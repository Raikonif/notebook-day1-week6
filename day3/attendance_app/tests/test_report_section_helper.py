from day3.attendance_app.src.report_section_helper import extract_section_rows
...
def test_extract_section_data_summary():
    data = [
        ...
        ['Diego Terrazas Sanchez', '10/10/22, 5:37:54 PM', '10/10/22, 5:38:21 PM', '26s',
         'Diego.Terrazas@fundacion-jala.org', 'Diego.Terrazas@fundacion-jala.org', 'Presenter'],
        [],
